	...
	<div class="modal-card">
		<form>
			...
			<section class="modal-card-body">
				<p class="control has-icons-left has-icons-right">
					<input class="input is-rounded" placeholder="Usuário" type="text" name="login" id="inputUsuario" required/>
					<span class="mdi mdi-account icon is-left"></span>
				</p>
				<p class="control has-icons-left has-icons-right mt-3">
					<input class="input is-rounded" placeholder="Login" type="password" name="login" id="inputLogin" required/>
					<span class="mdi mdi-lock icon is-left"></span>
				</p>
